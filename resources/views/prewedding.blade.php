...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('preweddingimage/menu.css') }}">
  <script src="{{ asset('preweddingimage/menu.js') }}"></script>
</head>
...
<body>
 ...
 <br><br><br><br>
  ...
  <div class="container-fluid">
    <div class="jumbotron">
      <center>
        <h1>Welcome to our Pre-Wedding page</h1>
        <p>
            In our website less amount of images because of customer does not give authentication us to upload
            his or her image. If you want to give order of your pre-wedding but some confusion then call us to
  ...
  <div id="myModal" class="modal">
   ...
   <div class="row">
  @foreach($row as $key)
     @if($key->type=="horizontal" && $key->category=="preweddingimage")  
    <img src="{{ 'preweddingimage/pre/'.$key->name }}" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/> 
     @endif
  @endforeach

  @foreach($row as $key)
     @if($key->type=="vertical" && $key->category=="preweddingimage")  
    <img src="{{ 'preweddingimage/pre/'.$key->name }}" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/> 
     @endif
  @endforeach
