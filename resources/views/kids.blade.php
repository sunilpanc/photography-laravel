...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('kidsimage/menu.css') }}">
  <script src="{{ asset('kidsimage/menu.js') }}"></script>
</head>
...
<body>
 ...
 <br><br><br><br>
  ...
  <div class="container-fluid">
    <div class="jumbotron">
      <center>
        <h1>Welcome to our Kids Shoot page</h1>
        <p>
            In our website less amount of images because of customer does not give authentication us to upload
            his or her image. If you want to give order of your kids shoot but some confusion then call us to
...
<!-- <img src="pre/1.jpg" alt=""  class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/> -->

    <div class="row">
  @foreach($row as $key)
  @if($key->type=="horizontal" && $key->category=="kidsimage")  
    <img src="{{ 'kidsimage/pre/'.$key->name }}" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/> 
     @endif
  @endforeach

  @foreach($row as $key)
     @if($key->type=="vertical" && $key->category=="kidsimage")  
    <img src="{{ 'kidsimage/pre/'.$key->name }}" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/> 
     @endif
  @endforeach
    </div>
