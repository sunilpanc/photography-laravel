...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar1 navbar-always">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item"><a href="/prewedding" class="nav-link">Pre-Wedding</a></li>
          <li class="nav-item"><a href="/wedding" class="nav-link">Wedding</a></li>
          <li class="nav-item"><a href="/modeling" class="nav-link">Modeling</a></li>
          <li class="nav-item"><a href="/kids" class="nav-link">Kids Shoot</a></li>
 ...
 <div class="container-fluid">
  ...
  <div class="row">
  @foreach($row as $key)
     @if($key->type=="vertical" && $key->category=="modelingimage")  
    <img src="{{ 'modelingimage/pre/'.$key->name }}" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/> 
     @endif
  @endforeach

  @foreach($row as $key)
  @if($key->type=="horizontal" && $key->category=="modelingimage")  
    <img src="{{ 'modelingimage/pre/'.$key->name }}" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/> 
     @endif
  @endforeach
    </div>
